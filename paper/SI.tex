...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.7\linewidth]{img/SI-eta-all.pdf}
...
\Fig{} \ref{}, the theoretical estimated value of $\delta$ (orange
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.75\linewidth]{img/SI-delta-estimate.pdf}
