...
\section{Graphene membrane manufacturing and 
results.}
\label{sec:exp}
...
\begin{table}[htbp]
  ...
  \caption{Different diffusivities for the anions and cations of the
    salts used in this work \cite{vanysek_2000}. The theoretical diffusion through PCTE can be
...
\begin{table}[htbp]
  ...
  \begin{tabular}{lcc}
    ...
    \hline
  \end{tabular}
  \caption{Conductivities and Debye lengths for the 6 different salts
    under investigation.}
