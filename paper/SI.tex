...
refinement of the mesh entities: (i) the smallest triangle mesh size
$\delta_{\mathrm{G}} / N_{\mathrm{div}}$, where $\delta_{\mathrm{G}}$
is the thickness of graphene, and (ii) division of mesh on the
boundary $0<r<R_{\mathrm{G}};z=0$ $N_{\mathrm{b}}$. The solution
convergence is evaluated by the mean absolute error (MAE) of anion
flux $\boldsymbol{J}_{z}$ on the boundary
$\delta_{\mathrm{G}} / N_{\mathrm{div}}$, as shown in \Fig
