...
Section \ref{SI-sec:R-model}).  \todo[inline]{Make sure that the
...
$1 - R_{\mathrm{G}}^{0}/R_{\mathrm{G}}$ from the observable flux reduction ratio $\eta$ (see Supplementary
\Fig{} \ref{SI-fig:eta-all}), as a function of $V_{\mathrm{G}}$ as
(details see Supplementary Section \ref{SI-sec:R-model}):
\begin{equation}
\label{eq:xi-def}
...
= 1.0, a high value of $\xi$ of $>$ 0.9 can be achieved.

% As discussed previously, the diffusive transport resistance of ungated patterned graphene 
