...
operational gate voltage window required to achieve the same order of
salt rejection may be narrower than graphene due to the larger quantum
capacitances \cite{Tian_2016}.
...
theoretical frameworks that bridge continuum and molecular scales are
required to resolve and predict the electrolyte transport when the
pore size is sub-5 nanometers.
% Nevertheless
